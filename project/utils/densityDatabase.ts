import { DensityData } from '../types/segmentation';

// Dummy density data for common food items (g/cm³)
export const FOOD_DENSITY_DATABASE: DensityData = {
  apple: {
    density: 0.85,
    name: 'Apple',
    category: 'fruit',
...
export function getFoodDensity(foodClass: string): number {
  ...
  // Default density for unknown foods (similar to water)
  return 1.0;
}
